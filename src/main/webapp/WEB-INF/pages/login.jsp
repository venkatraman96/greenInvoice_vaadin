          ...
          <section class="login_content">
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Green Invoice!</h1>
                  <p>Â©2016 All Rights Reserved. Green Invoice! is a Bootstrap 3 template. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
          ...
          <section class="login_content">
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Green Invoice!</h1>
                  <p>©2017 All Rights Reserved. Green Invoice! is a Bootstrap 3 template. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
